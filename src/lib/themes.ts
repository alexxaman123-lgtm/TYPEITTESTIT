...
export const THEMES: ThemeDefinition[] = [
  {
    ...
    variables: {
      ...
      "--color-accent-glow": "rgba(0,255,102,0.16)",
      "--color-accent-glow-secondary": "rgba(0,217,90,0.10)",
      "--color-ink": "#ffffff",
  ...
  },
  {
    ...
    variables: {
      ...
      "--color-accent-glow": "rgba(85,232,255,0.16)",
      "--color-accent-glow-secondary": "rgba(40,200,226,0.10)",
      "--color-ink": "#f7fdff",
  ...
  },
  {
    ...
    variables: {
      ...
      "--color-accent-glow": "rgba(181,140,255,0.16)",
      "--color-accent-glow-secondary": "rgba(148,104,239,0.10)",
      "--color-ink": "#fbf9ff",
  ...
  },
  {
    ...
    variables: {
      ...
      "--color-accent-glow": "rgba(255,138,91,0.16)",
      "--color-accent-glow-secondary": "rgba(237,107,56,0.10)",
      "--color-ink": "#fffaf7",
  ...
  },
  {
    ...
    variables: {
      ...
      "--color-accent-glow": "rgba(255,111,174,0.16)",
      "--color-accent-glow-secondary": "rgba(236,79,145,0.10)",
      "--color-ink": "#fff9fc",
  ...
  },
  {
    ...
    variables: {
      ...
      "--color-accent-glow": "rgba(255,209,102,0.16)",
      "--color-accent-glow-secondary": "rgba(235,181,70,0.10)",
      "--color-ink": "#fffdf5",
  ...
  },
  {
    ...
    variables: {
      ...
      "--color-accent-glow": "rgba(69,183,255,0.16)",
      "--color-accent-glow-secondary": "rgba(37,143,213,0.10)",
      "--color-ink": "#f8fcff",
  ...
  },
  {
    ...
    variables: {
      ...
      "--color-accent-glow": "rgba(255,173,122,0.16)",
      "--color-accent-glow-secondary": "rgba(237,135,87,0.10)",
      "--color-ink": "#fffaf5",
