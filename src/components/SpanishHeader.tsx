    ...
    <>
      <header className="sticky top-3 z-50 w-full px-2 pointer-events-none sm:top-5 sm:px-4 lg:px-6">
        <div className={cn(
          ...
          <a href="/es/" className="flex min-w-0 flex-1 items-center select-none" aria-label="Inicio de FreeTypingTestGoat">
            <span className="font-title min-w-0 truncate text-[13px] font-semibold leading-none tracking-tight sm:text-lg lg:text-xl">FreeTypingTestGoat</span>
            <img src="/goat-mark.svg" alt="" className="ml-1 h-5 w-5 shrink-0 sm:h-6 sm:w-6 lg:h-7 lg:w-7" aria-hidden="true" />
          </a>
