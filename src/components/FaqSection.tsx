const FAQS = [
  ...
  },
  {
    ...
    a: "GOATTYPE uses a standard character-based WPM approach for its speed measurement. For standard WPM comparisons, one word is represented by five typed characters. The live display helps you compare your pace while accuracy shows how reliably you typed the passage.",
  },
  {
  ...
  },
  {
    ...
    a: "A one minute typing test gives a quick snapshot of your typing speed, while a five minute typing test measures endurance and consistency over a longer stretch. Longer tests can reveal fatigue, while shorter tests are great for quick daily practice.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Select Custom Test, paste or write any text you would like to practice with, choose a duration, and start the test. The same typing engine tracks your WPM, accuracy and errors for custom text.",
  },
  {
  ...
  },
  {
    ...
    a: "Practice regularly with varied text, focus on accuracy before speed, learn proper touch-typing finger placement, and track your personal best over time. Gradually increasing difficulty from easy to hard typing tests can build both speed and control.",
  },
];
...
export default function FaqSection() {
  ...
  return (
    <section id="faq" className="mx-auto max-w-4xl scroll-mt-20 px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="mt-3 text-muted">Common questions about the GOATTYPE typing tester, WPM scoring, and how to get the most out of your practice.</p>
