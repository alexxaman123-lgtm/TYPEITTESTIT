  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="rounded-2xl border border-white/10 bg-surface1/50 p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.025)] sm:p-10">
        ...
        <h1 className="mt-3 text-3xl font-bold tracking-tight text-ink sm:text-4xl">ABOUT GOATTYPE</h1>
        <p className="mt-6 leading-7 text-muted">
          GOATTYPE was built around a simple idea: a typing speed test should be fast, honest, and
        ...
        <p className="mt-4 leading-7 text-muted">
          GOATTYPE offers three difficulty levels — Easy, Medium, and Hard — with different passages to
