  ...
  return (
    <div className="relative shrink-0" ref={dropdownRef}>
      <button
        ...
        aria-label={`Elegir tema. Tema actual: ${currentTheme.name}`}
      >
        <Palette size={14} />
              ...
              {THEMES.map((theme) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="ml-2 flex shrink-0 items-center gap-1 rounded-full border border-black/5 bg-canvas p-1 dark:border-white/5" aria-label={`${theme.name} colores`}>
