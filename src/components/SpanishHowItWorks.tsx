const STEPS = [
  ...
  { title: "Consulta tus resultados", body: "Al terminar, puedes ver WPM, precisión, errores y otras métricas. Puedes hacer el test sin iniciar sesión; algunas funciones de cuenta y clasificación requieren Google Sign-In." },
];
  ...
  return (
    <section id="how-it-works" className="mx-auto max-w-5xl scroll-mt-20 px-4 py-16 sm:px-6 lg:px-8">
      <div className="text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl font-body text-text-muted">FreeTypingTestGoat está diseñado para que entiendas el test en segundos: elige una dificultad, escribe, mide tu rendimiento y vuelve a practicar.</p>
      </div>
