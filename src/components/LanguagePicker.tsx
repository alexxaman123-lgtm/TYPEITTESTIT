  ...
  return (
    <div className="relative shrink-0" ref={ref}>
      <button
        ...
        className="flex h-8 min-w-[38px] items-center justify-center rounded-full border border-hairline bg-canvas px-2.5 font-label text-[11px] font-semibold uppercase tracking-[0.08em] text-ink transition-colors hover:bg-canvas-soft sm:h-9 sm:min-w-[42px] sm:text-xs"
        aria-haspopup="menu"
        aria-expanded={open}
