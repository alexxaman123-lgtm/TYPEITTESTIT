    ...
    <section id="guides" className="mx-auto max-w-5xl scroll-mt-20 px-4 py-16 sm:px-6 lg:px-8">
      <div className="text-center">
        ...
        <h2 className="mt-3 text-2xl font-bold tracking-tight text-ink sm:text-3xl">
          Typing Practice, Speed & Accuracy Guides
        </h2>
        <p className="mx-auto mt-3 max-w-2xl text-muted">
          Practical guides for people searching for typing practice, a typing speed test, better WPM,
          stronger accuracy, and a faster keyboard.
        </p>
      </div>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        {GUIDES.map((guide) => (
          <details
            key={guide.title}
            className="interactive-lift group rounded-2xl border border-white/10 bg-surface1/50 p-5 open:border-accent/30"
          >
